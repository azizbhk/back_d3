 ...
 * com.aziz.voyages.entities.Image; import
 * com.aziz.voyages.service.ImageService; import java.io.IOException;
 * 
 * @RestController
 * 
 * @RequestMapping("/api/image")
 * 
 * @CrossOrigin(origins = "*") public class ImageRestController {
 * 
 ...
 * Image getImageDetails(@PathVariable("id") Long id) throws IOException {
